...
class NamedEntitiesFinder
{
	...
	* Some setters
	******************************/
	public function setConjunctions($arr, $type = "start"){
		if(!is_array($arr))
		{
	...
	public function setSymbols($arr){
		if(!is_array($arr))
		{
	...
	public function setPunctuation($arr){
		if(!is_array($arr))
		{
	...
	public function multiWords($bool){
		if($bool)
		{
	...
	public function stopWords($arr){
		if(!is_array($arr))
		{
			$this->stopWords = array(mb_strtolower($arr));
		}
		else
		{
			$new = array();
	...
	******************************/
	...
	private function get_multiWords($proper, $words){
		$multi = array();
	...
	******************************/
	public function get($text){
		...
		if(!empty($this->stopWords))
		{
			...
			{
				if(!in_array(mb_strtolower($val), $this->stopWords))
				{
					$new[] = $val;
				}
			}
		...
		if($this->multiWords)
		{
			$proper = $this->get_multiWords($proper, $words);
		}
		return $proper;
	}
}
